...
public class FaxController {
    ...
    // No @Transactional — ContactSuggestionService.suggestContact has its own
    ...
    public ResponseEntity<Map<String, String>> predictContact(
        ...
        Map<String, String> response = new HashMap<>();
        try {
            String predictedFaxNumber = contactSuggestionService.suggestContact(partialInput);
    ...
    // No @Transactional — ContactSuggestionService.autoSendFaxAsync owns its own
    ...
    public ResponseEntity<Map<String, String>> autoSendFax(
        ...
        String resolvedPath = faxUploadService.resolveToString(uploadId);
        try {
            contactSuggestionService.autoSendFaxAsync(partialInput, resolvedPath)
